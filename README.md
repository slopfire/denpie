...
- **Forced Card Refresh**: The browser flow and protobuf API can dismiss the current generated daily cards for selected topics and immediately pull fresh cards.
