...
- **Forced Card Refresh**: The settings screen can dismiss the current generated daily cards across all topics and immediately pull fresh cards; the protobuf API can also target selected topics.
